...
- Using Bun package management, it implements the `workspace` and `catalog` protocols, simplifying the version management of dependent packages.
  Now, to install dependencies for project must use `bun i`
- Updated some dependent packages
