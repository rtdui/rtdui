import { getDataProps } from "@rtdui/core";
import { useSpotlightContext } from "./Spotlight.context";
import { spotlightActions } from "./spotlight.store";
import { Highlight } from "./Hightlight";

export interface SpotlightActionProps extends React.ComponentProps<"a"> {
...
export function SpotlightAction(props: SpotlightActionProps) {
  const {
    ref,
    className,
    style,
