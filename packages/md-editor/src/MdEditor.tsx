...
import { MdEditPart } from "./MdEditPart";
import { MdPreviewPart } from "./MdPreviewPart";
import { Sidebar } from "./Sidebar";
import { Statusbar } from "./Statusbar";
import { Toolbar } from "./Toolbar";
import { MdEditorContext } from "./context";
...
export function MarkdownEditor(props: MdEditorProps) {
  ...
  const locale: Locale = { ...enLocale, ...localeProp };
  ...
  const [activedSidebar, setActivedSidebar] = useState<ActivedSidebar>("none");
