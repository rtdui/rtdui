...
export type MdPreviewPartOwnProps = {};
export type MdPreviewPartProps = MdPreviewPartOwnProps &
  Omit<React.ComponentProps<"div">, keyof MdPreviewPartOwnProps>;

export function MdPreviewPart(props: MdPreviewPartProps) {
