import { useState, useImperativeHandle, Children, cloneElement } from "react";
import clsx from "clsx";
import { TabsSimplePanel, type TabsSimplePanelProps } from "./TabsSimplePanel";
import type { ThemeBaseSize } from "../theme.types";

export interface TabsSimpleProps extends React.ComponentProps<"div"> {
  /**
   * 变体
   * @default lifted
   */
...
export function TabsSimple(props: TabsSimpleProps) {
  const {
    ref,
    initIndex = 0,
    variant = "lift",
