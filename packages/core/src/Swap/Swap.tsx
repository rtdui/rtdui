import { Children } from "react"; // forwardRef的组件必须是这种形式, 否则gendoc生成会忽略该组件.
import clsx from "clsx";

export interface SwapProps extends React.ComponentProps<"input"> {
  /**
   * 是否启用中间态
   * @deprecated v5不再有效果
   */
...
export function Swap(props: SwapProps) {
  ...
  return (
    ...
    >
      <input {...other} ref={ref} type="checkbox" className="hidden" />
