...
import { clamp, useMove, useUncontrolled } from "@rtdui/hooks";
    ...
    >
      <Track
        ...
        containerProps={{
          ...
          onTouchStartCapture: (ev) => (ev.target as HTMLDivElement).focus(),
          onMouseDownCapture: (ev) => (ev.target as HTMLDivElement).focus(),
