...
import { useMutationObserverTarget, useRafDebounce } from "@rtdui/hooks";
 ...
 */
export interface WatermarkProps extends React.ComponentProps<"div"> {
  /** 图像url */
  imageSrc?: string;
  text?: string | string[];
  /** 旋转度数, 正数顺时针, 负数逆时针
...
export function Watermark(props: WatermarkProps) {
  ...
  return <div ref={containerRef} className={clsx("relative z-0")} {...other} />;
}
